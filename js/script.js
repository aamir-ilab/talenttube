...
//     var phonePatt =  /^[0-9-+]+$/;
//     var stringPatt = /^[A-Za-z ]+$/;
//     var agePatt = /^[0-9]{1,2}$/;
//     var emailPatt = /^([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5})$/;
 
//     if ($('#first_name').val() == '')
//         {
//           $(".first_name").html("<span>Field is requered</span>");
         
//           $(".final_name").show();
//           $(".first_name").html("<span class = \"text text-danger\">Enter Name Only Alphabets</span>");
//           $('#first_name').parents(".first_form").find(".text").attr('hidden',false);

        

//          return  false;
//         }
//         else if(stringPatt.test($('#first_name').val())==false)
//         {
//             $(".first_name").html("<span class = text text-danger>Only Alphabets</span>");
              
//             //$('#first_name').focus().css("border","1px solid red");
//             return  false;
//          }
//         else{
//             $(".first_name").parents(".first_form").find(".text").attr('hidden', true);
          
//         } 
        
//       if ($('#last_name').val() == '')
//         {
//           $(".last_name").html("<span>Field is requered</span>");
         
//           $(".final_name").show();
//           $(".last_name").html("<span class = \"text text-danger\">Enter Name Only Alphabets</span>");
//           $('#last_name').parents(".first_form").find(".text").attr('hidden',false);

//           //$('#last_name').focus().css("border","1px solid red");

//          return  false;
//         }
//         else if(stringPatt.test($('#last_name').val())==false)
//         {
//             $(".last_name").html("<span class =text text-danger>Only Alphabets</span>");
...
//         {
//           $(".final_name").show();
//           $(".email").html("<span class = text text-danger>Required</span>");
         
//           //$('#email').focus().css("border","1px solid red");
//              return  false;
//         }
//         else if(emailPatt.test($('#email').val())==false)
//         {
//            $(".email").html("<span class = text text-danger>Email Pattern</span>");
...
//          $(".phone").html("<span class = text text-danger>Phone Number is ReQuired</span>");
         
//           //$('#phone').focus().css("border","1px solid red");
//            return  false;
//         }
//         else if(phonePatt.test($('#phone').val())==false)
//         {
//            $(".phone").html("<span class = text text-danger>Only Integer withOut dash</span>");
...
//         {
//           $(".final_name").show();
//           $(".age").html("<span class = text text-danger>Required</span>");
           
//           //$('#age').focus().css("border","1px solid red");
//         return  false;
//         }
//         else if(agePatt.test($('#age').val())==false)
//         {
//            $(".age").html("<span class = text text-danger >Only Integer</span>");
